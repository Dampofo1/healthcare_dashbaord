...
app.layout = dbc.Container([
    ...
    dbc.Row([
        ...
        dbc.Col(html.Div(f"Average Billing Amount: ${avg_billing:,.2f}", className='text-center my-2 top-text'),
                width=5),
    ], className='mb-4'),
            ...
            dbc.Card([
                dbc.CardBody([
                    ...
                    dcc.Slider(
                        ...
                        marks={int(value): f'${int(value):,}' for value in
                               df['Billing Amount'].quantile([0, 0.25, 0.5, 0.75, 1]).values},
                        step=100
                    ),
        ...
        dbc.Col([
            dbc.Card([
                dbc.CardBody([
                    ...
                    dcc.Dropdown(
                        id="condition-filter",
                        options=[{"label": condition, "value": condition} for condition in
